...
<br><br>
	<center>	<h2 class="card-title">Issue Processed Material</h2>
    
    	<br><br>
		<form action="issuedpro" method="post">
		  <div class="form-row">
		    ...
		    <div class="form-group col-md-5">
		      ...
		      <input type="text" name="iname" class="form-control" id="inputAddress" placeholder="Issuer Name">
		    </div>
		  </div>
		  
		  <div class="form-row">
		    <div class="form-group col-md-5">
		      <label for="inputAddress">Issuer Id:</label>
		      <input type="text" name="sid" class="form-control" id="inputAddress" placeholder="Issuer Id">
		    </div>
		    <div class="form-group col-md-5">
		  ...
		  <input type="hidden" name="prid" value="<%=request.getParameter("prid") %>">
		   
		  </div>
		  <button type="submit" class="btn btn-primary">Issue Processed Material</button>
		</form>
</center>
    <!-- Optional JavaScript -->
